...
if exists("g:DoxygenToolkit_commentType")
  if ( g:DoxygenToolkit_commentType == "C++" )
    ...
    let g:DoxygenToolkit_interCommentBlock = "// "
    let g:DoxygenToolkit_endCommentBlock = ""
  elseif ( g:DoxygenToolkit_commentType == "Rainbow" )
    let g:DoxygenToolkit_startCommentTag = "//! "
    let g:DoxygenToolkit_interCommentTag = "//! "
    let g:DoxygenToolkit_endCommentTag = ""
    let g:DoxygenToolkit_startCommentBlock = "//"
    ...
    let g:DoxygenToolkit_blockFooter=
        \ "--------------------------------------------------------------------------------------------------"
    let g:DoxygenToolkit_blockBigHeader=
        \ "=================================================================================================="
    let g:DoxygenToolkit_blockBigFooter=
        \ "=================================================================================================="
    let g:DoxygenToolkit_briefTag_funcName = "yes"
    let g:DoxygenToolkit_columnLimit = 100
    let g:DoxygenToolkit_fileTag = "\\file "
    let g:DoxygenToolkit_authorTag = "\\author "
    let g:DoxygenToolkit_dateTag = "$Date: "
    let g:DoxygenToolkit_versionTag = "$Revision: "
    let g:DoxygenToolkit_groupTag = "\\ingroup "
  else
...
function! <SID>DoxygenAuthorFunc()
  ...
  " ==== get project name to follow the Rainbow style start ====
  if ( g:DoxygenToolkit_commentType ==# "Rainbow" )
    if !exists("g:DoxygenToolkit_projectString")
      let g:DoxygenToolkit_projectString = input("Enter Project string : ")
    endif
  endif
  " ==== get project name to follow the Rainbow style end ====
  ...
  " ==== insert file header to follow the Rainbow style start ====
  if ( g:DoxygenToolkit_commentType ==# "Rainbow" )
    ...
    " add prject name
    if exists("g:DoxygenToolkit_blockBigHeader")
      if( g:DoxygenToolkit_blockBigHeader != "" )
          exec "normal! O".strpart( s:startCommentBlock, 0 ).g:DoxygenToolkit_blockBigHeader.s:endCommentBlock
          let l:projectStringFormat = printf("%%%ds", 
            \ (g:DoxygenToolkit_columnLimit + len(g:DoxygenToolkit_projectString))/2 - len(s:interCommentBlock))
          let l:formatedProjectString = printf(l:projectStringFormat, g:DoxygenToolkit_projectString)
          exec "normal! o".strpart( s:interCommentBlock, 0 ).l:formatedProjectString
          exec "normal! o".strpart( s:startCommentBlock, 0 ).g:DoxygenToolkit_blockBigHeader.s:endCommentBlock
          " add empty comment
          exec "normal! o".strpart( s:startCommentBlock, 0 )
          " for StartDocumentationBlock() will jumps a line up and start insert...
          exec "normal! j"
      endif
    endif
    ...
    " file name
    exec "normal! ".l:insertionMode.s:interCommentTag.printf("%-13s", g:DoxygenToolkit_fileTag).l:fileName
    " group
    exec "normal! o".s:interCommentTag.printf("%-13s", g:DoxygenToolkit_groupTag)
    " brief
    exec "normal! o".s:interCommentTag.printf("%-13s", g:DoxygenToolkit_briefTag_pre)
    mark d
    exec "normal! o".strpart( s:startCommentTag, 0 )
    " license
    exec "normal! o".s:interCommentTag.g:DoxygenToolkit_licenseTag
    " author
    exec "normal! o".s:interCommentTag.printf("%-13s", g:DoxygenToolkit_authorTag).g:DoxygenToolkit_authorName
    " empty comment
    exec "normal! o".strpart( s:startCommentBlock, 0 )
    " date time
    let l:date = strftime("%Y/%m/%d %H:%M:%S")
    exec "normal! o".s:interCommentBlock.g:DoxygenToolkit_dateTag.l:date
    if (exists("g:DoxygenToolkit_timezoneString"))
        if ( g:DoxygenToolkit_timezoneString !=# "" )
            exec "normal! A".g:DoxygenToolkit_timezoneString
        endif
    endif
    exec "normal! A"." $"
    ...
    " revision
    exec "normal! o".s:interCommentBlock.g:DoxygenToolkit_versionTag.g:DoxygenToolkit_versionString
    exec "normal! A"." $"
    " empty comment
    exec "normal! o".s:interCommentBlock
    exec "normal! o".strpart( s:startCommentBlock, 0 ).g:DoxygenToolkit_blockBigFooter.s:endCommentBlock
  " ==== insert file header to follow the Rainbow style end ====
  else
    " Get file name
...
function! <SID>DoxygenBlockFunc()
  ...
  " ==== insert block to follow the Rainbow style start ====
  if ( g:DoxygenToolkit_commentType ==# "Rainbow" )
    let l:blockString = input("Enter the block name : ")
    ...
    " add block name
    let l:upperBlockString = toupper(l:blockString)
    let l:outBlockString = ""
    for i in range(len(upperBlockString))
        let l:outBlockString = l:outBlockString." ".upperBlockString[i]
    endfor
    exec "normal! o".strpart( s:interCommentBlock, 0 ).l:outBlockString
    mark d
    " add footer
    if exists("g:DoxygenToolkit_blockBigFooter")
      if( g:DoxygenToolkit_blockBigFooter != "" )
          exec "normal! o".strpart( s:startCommentBlock, 0 ).g:DoxygenToolkit_blockBigFooter.s:endCommentBlock
      endif
    endif
    exec "normal! `d"
    " ==== insert block to follow the Rainbow style end ====
  else
    let l:insertionMode = s:StartDocumentationBlock()
...
function! <SID>DoxygenCommentFunc()
  ...
  " ==== insert function name to follow the Rainbow style start ====
  if ( g:DoxygenToolkit_commentType ==# "Rainbow" )
      if( l:doc.name != "None" )
          exec "normal! O".strpart( s:interCommentBlock, 0). " " .l:doc.name
          exec "normal! `d" 
          if( g:DoxygenToolkit_blockHeader != "" )
              exec "normal! O".strpart( s:startCommentBlock, 0, 2 ).g:DoxygenToolkit_blockHeader.s:endCommentBlock
              exec "normal! `d" 
          endif
      endif
  endif
  " ==== insert function name to follow the Rainbow style end ====
